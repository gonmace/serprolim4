...
def copy_pivot_data(apps, schema_editor):
    ...
    Social = apps.get_model('generalData', 'Social')
    # Analytics settings are in analytics app
    try:
        AnalyticsSettings = apps.get_model('analytics', 'AnalyticsSettings')
    except LookupError:
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('generalData', '0011_countrysettings_body_scripts_and_more'),
