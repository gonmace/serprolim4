...
def copy_pivot_data(apps, schema_editor):
    ...
    Social = apps.get_model('wgeneralData', 'Social')
    # Analytics settings are in wanalytics app
    try:
        AnalyticsSettings = apps.get_model('wanalytics', 'AnalyticsSettings')
    except LookupError:
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('wgeneralData', '0011_countrysettings_body_scripts_and_more'),
